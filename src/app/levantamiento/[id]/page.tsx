              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Fecha de envío</p>
                  </div>
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              {scoringResult && (
                <button
                  onClick={() => levantamiento && evaluateSubmission(levantamiento)}
                  className="inline-flex items-center justify-center w-10 h-10  hover:bg-blue-700 text-white rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95"
                >
